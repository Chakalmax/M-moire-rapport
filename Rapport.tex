...
%\begin{mydef}
%On dit que $\varphi_2$ est un raffinement de $\varphi_1$, noté $\varphi_1 \preceq \varphi_2$  si pour chaque attribut $A \in S$,
%nous avons que $\varphi_2(A) \subseteq \varphi_1(A)$.  
%\end{mydef}
%
%\begin{myexample}
